...
import { ArrowRight, CheckCircle, PlaneTakeoff } from "lucide-react";
  ...
  if (error || !booking) {
    return (
      <div
        ...
        style={{ padding: "2rem", textAlign: "center", color: "var(--error)" }}
      >
  ...
  const leadPassenger =
    passengers.length === 0
      ...
      : typeof passengers[0] === "object"
        ? passengers[0].name ||
          `${passengers[0].first_name || ""} ${passengers[0].last_name || ""}`.trim()
        : String(passengers[0]);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div>
              ...
              <h4 className="font-bold" style={{ fontSize: "1.2rem" }}>
                {flightDetails.origin || "N/A"}
              </h4>
        ...
        >
          ...
          <Link to="/dashboard" className="btn" style={{ position: "relative", zIndex: 30 }}>
